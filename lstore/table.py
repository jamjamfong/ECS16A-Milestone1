...
class Table:
    ...
    def get_version_column_value(self, rid, column_index, relative_version):
        ...
        for i, tail_rid in enumerate(version_chain):
            ...
            if schema_bits[column_index] == '1':
                ...
                if versions_seen > relative_version:
                    return int.from_bytes(
                        tail_page_range[4 + column_index].data[tail_offset:tail_offset + 8],
                        byteorder='little',
                        signed=True
        ...
        # If we didn't find enough versions in tail, return base value
    ...
    def update_record(self, rid, columns):
        ...
        for i, value in enumerate(columns):
            if value is not None:
                ...
                current_tail_range[4 + i].write(0)  # Placeholder for unchanged columns
